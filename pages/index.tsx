  ...
  <div className="bg-[url(/dishes.jpg)] h-[100vh] flex flex-col justify-between">
    ...
    <main className="flex flex-col items-center justify-center flex-grow">
      <div className="flex flex-col items-center rounded-lg bg-white/[0.9] px-5 lg:px-20 py-10">
        <h1 className="text-6xl font-bold mb-4 text-black"><span className="text-red-500 text-8xl italic">N</span>ear GOHAN</h1>
        ...
        <div className="space-x-4">
          ...
          <button className="px-4 py-2 bg-red-500 text-white rounded" onClick={handleSearch}>検索</button>
        </div>
      </div>
    </main>
    <Footer/>
